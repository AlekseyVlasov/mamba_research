...
class MixerModelWithEmbeddings(nn.Module):
    def __init__(
        self,
        d_model: int,
        n_layer: int,
    ...
    def forward(self, input_ids, inference_params=None, is_embeds=False, **mixer_kwargs):
        if is_embeds:
...
class MambaLMHeadModelWithEmbeddings(nn.Module, GenerationMixin):
    ...
    def __init__(
        ...
        self.backbone = MixerModelWithEmbeddings(
            d_model=d_model,
            n_layer=n_layer,
            d_intermediate=d_intermediate,
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None, num_last_tokens=0, is_embeds=False, **mixer_kwargs):
        """
